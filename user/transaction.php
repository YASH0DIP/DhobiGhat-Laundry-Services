...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0 toggled" style="background: #4a4a4b;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3" style="font-size: 18px"><span>DHOBIGHAT</span></div>
                </a>
                ...
                <div class="text-center d-none d-md-inline" style="margin-top: 10px;"><button class="btn rounded-circle border-0" id="sidebarToggle" type="button"></button></div>
            </div>
        </nav>
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">My Account</span><i class="far fa-user"></i></a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in"><a class="dropdown-item" href="profile.php"><i class="fas fa-cogs fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Settings</a><a class="dropdown-item <?php if($_SESSION['level'] != '0'){echo 'd-none';}?>" href="logs.php"><i class="fas fa-list fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Activity log</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <button class="btn btn-secondary btn-md mb-1 <?php if ($fullname != 'NONE') {echo 'd-none';}?>" type="button" data-bs-target="#transaction" data-bs-toggle="modal"><i class="fas fa-truck-loading fa-sm text-white-50"></i>&nbsp;New Order</button>
                    </div>
                    ...
                    <div class="card shadow mb-3 <?php if ($fullname == 'NONE') {echo 'd-none';}?>">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col">
                                    <p class="text-primary m-0 fw-bold">Order Information</p>
                                </div>
                                <div class="col text-end">
                                    <button class="btn btn-light mx-2 mb-1" type="button" data-bs-target="#confirm" data-bs-toggle="modal">Cancel</button>
                                    <button class="btn btn-secondary mb-1" type="button" data-bs-target="#proceed" data-bs-toggle="modal">Proceed</button></div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                                <button class="btn btn-secondary btn-sm mb-1 <?php if ($fullname == 'NONE') {echo 'd-none';}?>" type="button" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-truck-loading fa-sm text-white-50"></i>&nbsp;Customize Your Order</button> 
                            </div>
                        ...
                        <div class="col">
                            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                                <button class="btn btn-secondary btn-sm mb-1 <?php if ($fullname == 'NONE') {echo 'd-none';}?>" type="button" data-bs-target="#laundry-add" data-bs-toggle="modal"><i class="fas fa-truck-loading fa-sm text-white-50"></i>&nbsp;Add Laundry</button> 
                            </div>
                            <div class="card shadow <?php if ($fullname == 'NONE') {echo 'd-none';}?>">
                                <div class="card-header py-3">
            ...
            <footer class="bg-white sticky-footer">
                ...
                <div class="text-center my-auto copyright">
                        <span>Copyright © DHOBIGHAT&nbsp;2024</span><br><br>
                        <span style="font-size: 14px; opacity: 0.5;">Developed By Yashodip & Harshali
                        with <i class="fa fa-heart"></i> &
                        <i class="fa fa-mug-hot"></i> in Nashik.
                        </span>
                    </div>
                </div>
            </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-product.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label"><strong>Other Comments</strong></label><input class="form-control" type="text"  name="comments" placeholder="Any Special Requirements..." value="None"></div>
                </div>
                <div class="modal-footer"><button class="btn btn-secondary" type="submit">Add</button></div>
                </form>
            </div>
        </div>
    </div>
    <div class="modal fade" role="dialog" tabindex="-1" id="laundry-add">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button><button class="btn btn-secondary" type="submit">Add</button></div>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="confirm">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Cancel Order</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="proceed">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Proceed Order</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer"><button class="btn btn-light pay" type="submit" data-bs-dismiss="modal">Pay Now</button><button class="btn btn-secondary next" type="submit">Cash on Delivery</button></div>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(".next").click(function(){
            $(".main-form").attr("action","functions/proceed-transaction.php");
            $.ajax({
            type: "POST",
            url: "proceed-transaction.php",
            data: {
                kilo: kilo, // Replace with the actual variable containing kilo data
                type: type, // Replace with the actual variable containing type data
                amount: amount, // Replace with the actual variable containing amount data
                id: id // Replace with the actual variable containing id data
            },
            success: function(response) {
                window.location.href = "proceed-transaction.php";
            }
        });
        });
        $(".pay").click(function(){
            $(".main-form").attr("action","functions/payment.php");
            $.ajax({
            type: "POST",
            url: "payment.php",
            data: {
