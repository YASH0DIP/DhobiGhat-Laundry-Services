            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/profile.png" width="125" height="118">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="functions/update-account.php" method="post">
                                                ...
                                                <div class="mb-3"><button class="btn btn-secondary btn-md" type="submit">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
