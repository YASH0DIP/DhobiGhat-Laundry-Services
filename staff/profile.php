            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/profile.png" width="120" height="118">
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form action="functions/update-account.php" method="post">
                                                ...
                                                <div class="mb-3"><button class="btn btn-primary btn-md" type="submit">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Pricing Settings</h3><button class="btn btn-primary" type="button" data-bs-target="#add" data-bs-toggle="modal"><i class="fas fa-user-check fa-sm text-white-50"></i>&nbsp;Add Clothes</button>
                    </div>
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
