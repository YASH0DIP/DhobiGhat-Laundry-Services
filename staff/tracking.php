                    ...
                    <div class="card text-black card-stepper" style="border-radius:16px;">
                        <div class="card-body p-5">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <p class="mb-0">DHOBIGHAT Laundry Services</p>
                                    </div>
                                </div>
                            </div>
                            <?php
                            ...
                            ?>
                                <div class="d-flex justify-content-between align-items-center mb-5">
                                    <div>
                                        <!-- <h2 class="mb-2">Q<span class="text-primary font-weight-bold">#<?php echo $queue_number; ?></span></h2> -->
                                        <h5 class="mb-0 ms-5 font-monospace">Type - <span class="text-primary font-weight-bold"><?php echo $row['name']; ?></span></h5>
                                        <h5 class="mb-0 ms-5 font-monospace">Load - <span class="text-primary font-weight-bold"><?php echo $row['kilo']; ?>&nbsp;Unit</span></h5>
                                    </div>
                                </div>
