...
if (count($results) > 0){
    header('location: ../transaction.php?type=error&message=You have an existing order!');
    exit();
}
if (empty($id)){
...
generate_logs('Adding Order', 'New Order was added');
header('location: ../transaction.php?type=success&message=Order Added Successfully!');