...
<body id="page-top">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-customer.php" method="post">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="first_name"><strong>First Name</strong></label><input class="form-control" type="text" placeholder="Firstname" name="firstname" required=""></div>
                            </div>
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="last_name"><strong>Last Name</strong></label><input class="form-control" type="text" placeholder="Lastname" name="lastname" required=""></div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Contact No.</strong></label><input class="form-control" type="text" placeholder="Contact No." name="contact" required="" minlength="10" maxlength="10"></div>
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Email</strong></label><input class="form-control" type="email" placeholder="Email" name="email" required></div>
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="password"><strong>Password</strong></label><input class="form-control" type="password" placeholder="Password" name="password" required=""></div>
                            </div>
                        </div>
                </div>
    ...
    <script>
        ...
        $('a[data-bs-target="#update"]').on('click', function() {
                ...
                console.log(id, firstname, lastname, address, contact, username);
